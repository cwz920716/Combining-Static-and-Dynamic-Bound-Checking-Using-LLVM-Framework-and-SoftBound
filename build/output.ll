...
entry:
  ...
  call void @__track_heap_allocation(i8* %call, i64 %mul)
  ret i32 %s
}
...
entry:
  ...
  call void @__track_stack_allocation(i8* %0, i64 10, i64 32, i64 16)
  br label %for.cond
...
declare void @__track_stack_allocation1(i8*, i64, i64, i64)

declare void @__track_heap_allocation2(i8*, i64)
